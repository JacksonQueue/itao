...
public abstract class AbsBasicController implements ApplicationContextAware, Constants {
	 ...
	 * @return
	 */
	public String buildFullServerUrl(String requestUri) {
		return WebHelper.createFullServerUrl(getRequest(), requestUri);
	}
	 ...
	 * @return
	 */
	public String getNextUrlOrIndexUrl() {
		String nextUrl = getNextUrl();
		if (StringUtils.isBlank(nextUrl))
			nextUrl = buildFullServerUrl(SysConf.indexUrl());
		return nextUrl;
	}
